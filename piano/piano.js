...
function keyPressed() {
  ...
  case 70: // F
  case 102: // f
    piano.play('E' , high,2); // E note
    notePressed[7] = true;
    break;
  case 71: // G
  case 103: // g
    piano.play('F' , high,2); // F note
    notePressed[8] = true;
    break;
  case 89: // Y
  case 121: // y
